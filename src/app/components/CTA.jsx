export default function CTA() {
  return (
    <section className="mx-auto my-6 flex w-5/6 max-w-3xl flex-col items-center rounded-xl bg-gradient-to-b from-[#242424] to-[#8A8A8A] py-6 text-center md:py-12">
      ...
      <button className="mt-8 cursor-pointer rounded-lg bg-gradient-to-r from-[#5749E9] to-[#372DA2] px-6 py-3 font-semibold text-white shadow-md">Upload Your Design</button>
    </section>
  );
}
